...
export default {
  ...
  methods: {
    iniciarVariante: function (variante) {
...
<style scoped>
/* Asegúrate de que la fuente externa no cause problemas en iOS 9 */
...
.menu-centro {
  ...
  top: 50%;
  left: 50%;
  /* El transform puede fallar en navegadores antiguos si no tiene prefijo */
